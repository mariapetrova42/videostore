...
<?php
    ...
    if (isset($_SESSION["member_username"]) && $_SESSION["member_username"]!=""){
        ...
        $insert = "insert into transaction(tran_date, tran_type, item_id, Store_id, member_id) values ('$tran_date', 'borrow', $item_id, $store_id, $member_id);";
